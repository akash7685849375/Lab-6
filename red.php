...
<html lang="en">
	...
	<body id="section2">
		...
		<header>
			...
			<nav>
				<ul>
					...
					<li><a href="red.php" title="red blocks">Red Blocks</a></li>
					<li><a href="blue.php" title="blue blocks">Blue Blocks</a></li>
					<li><a href="yellow.php" title="yellow blocks">Yellow Blocks</a></li>
				</ul>
			</nav>
		</header>
		...
		<footer>
			<nav>
				<a href="about/privacy-policy.php" title="Privacy Policy">Privacy Policy</a> | <a href="about/privacy-policy.php#personal-information" title="Learn about how we treat your personal information">Use of Personal Information</a>
			</nav>
